<template>
    ...
    <error-msg :errmsg='errmsg' v-if="errmsg"></error-msg>
      ...
      <div  v-show="hash == 'bmemail'" class="hgt2">
        ...
        <email-counter :localaccount="user.email"></email-counter>
        <button-common  @click="" btnclass="btn-primary form_btnpos01" btntext="立即进入邮箱" :datahref="gointoemailurl"></button-common>  
      </div>
      <!-- 通过邮箱绑定手机号第二步 -->
      <div v-show="hash == 'bmphone'" class="hgt2">
        <process-step firstttext="手机号" processclass="pwd-title-step2"></process-step>
        <form-account iptplaceholder="请输入手机号" labelname="手机号：" ></form-account>
      ...
      <div v-if="hash == 'bmcode'" class="hgt2">
        ...
        <phonecode :phone="user.account" regethref="bindbyemail.html#bmphone" phonetxtclass="form-phonetxt2" iptclass="form-group-mt03"></phonecode>
